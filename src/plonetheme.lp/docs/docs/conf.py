...
# plonetheme.lp build configuration file
...
project = "plonetheme.lp"
author = "hauxhaux"
trademark_name = "hauxhaux"
now = datetime.now()
year = str(now.year)
copyright = year
...
linkcheck_ignore = [
    ...
    r"https://github.com/hauxhaux/plonethemelp/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/hauxhaux/plonethemelp",
    ...
    "repository_url": "https://github.com/hauxhaux/plonethemelp",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/hauxhaux/plonethemelp/edit/main/docs/",
# }
...
ogp_site_name = "plonetheme.lp Documentation"
ogp_type = "website"
...
htmlhelp_basename = "plonetheme.lpDocumentation"
...
latex_documents = [
    (
        "index",
        "plonetheme.lpDocumentation.tex",
        "plonetheme.lp Documentation",
        "hauxhaux community",
        "manual",
    ),
]
